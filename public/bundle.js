...
var _UserInfo = __webpack_require__(85);
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { path: '/users/:id', component: _UserInfo2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: 'addUser', component: _AddUser2.default })
        )
    );
};
...
var AddUser = function (_React$Component) {
  ...
  _createClass(AddUser, [{
    ...
    value: function handleClick(evt) {
      ...
      _superagent2.default.post('/users/addUser').send({
